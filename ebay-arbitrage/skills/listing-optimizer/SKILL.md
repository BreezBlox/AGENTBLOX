...
Before publishing, run the listing through the full fee stack. Read `references/ebay-fee-structure.md`
for current rates, or use `scripts/margin_calculator.py` to compute:
