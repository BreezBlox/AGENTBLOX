...
`references/supplier-vetting-checklist.md` for the full checklist, but here's the high-level
framework:
...
Read `references/landed-cost-formula.md` for the complete methodology, or use
`scripts/landed_cost.py` to calculate. The components:
...
3. **International freight** — the big variable. Read `references/shipping-lanes.md` for
...
Read `references/shipping-lanes.md` for the complete guide. Quick decision framework:
