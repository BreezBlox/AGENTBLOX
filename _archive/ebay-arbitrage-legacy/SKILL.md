...
This is a multi-skill domain with five specialist sub-skills. You should read the relevant
...
|-----------|-------------|------|
| **Listing Optimizer** | eBay SEO, sold comps, Terapeak analysis, listing copywriting, pricing strategy, fee math | `skills/listing-optimizer/SKILL.md` |
| **Sourcing Analyst** | Supplier vetting, AliExpress/Alibaba research, landed cost, MOQ, shipping lanes, quality risk | `skills/sourcing-analyst/SKILL.md` |
| **Arbitrage Calculator** | Profit/ROI analysis, deal scoring, demand-supply matching, go/no-go decisions | `skills/arbitrage-calculator/SKILL.md` |
| **Compliance Guardian** | VeRO/IP risk, eBay policy, restricted categories, suspension risk, returns exposure | `skills/compliance-guardian/SKILL.md` |
| **Meta Improver** | Process improvement, knowledge gaps, workflow optimization, output quality enhancement | `skills/meta-improver/SKILL.md` |
...
|-----------|----------|------|
| eBay Fee Structure | FVF by category, insertion fees, promoted listings, international fees, payment processing | `references/ebay-fee-structure.md` |
| Shipping Lanes | China→US/EU shipping methods, real transit times, cost ranges, customs considerations | `references/shipping-lanes.md` |
| VeRO Quick Reference | High-risk brands, IP enforcement patterns, safe harbor categories | `references/vero-quick-ref.md` |
| Supplier Vetting Checklist | Due diligence framework for AliExpress/Alibaba/1688 suppliers | `references/supplier-vetting-checklist.md` |
| Landed Cost Formula | Complete landed cost methodology including duties, fees, insurance, FX risk | `references/landed-cost-formula.md` |

## Utility Scripts

| Script | Purpose | Path |
|--------|---------|------|
| Margin Calculator | Full eBay profit margin calculation with all fees and costs | `scripts/margin_calculator.py` |
| Landed Cost Calculator | Compute total landed cost from China to destination | `scripts/landed_cost.py` |
